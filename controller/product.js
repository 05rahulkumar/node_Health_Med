...
module.exports = {
    createProduct: async (req, res) => {
        ...
        try {
            const { name, qty, color, size, discount, amount, final_amount, rating, is_cart, is_wishlist } = req.body;
            let image = req.file ? req.file.path.replace(/\\/g, '/') : null;
            const product = new productModel({ name, image, qty, color, size, discount, amount, final_amount, rating, is_cart, is_wishlist });
